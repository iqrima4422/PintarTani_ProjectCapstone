                ...
                <form method="post" action="{{ route('PostCreateUser') }}" enctype="multipart/form-data" id="myForm">
                    ...
                    <div class="form-group">
                        <div class="d-flex flex-column align-items-center" style="text-transform: none">
                            <div class="rounded-circle overflow-hidden mt-5" style="width: 150px; height: 150px;">
                                <img id="preview-image-before-upload" class="w-100 h-100 object-fit-cover"
                                    style="object-fit: cover;">
                            </div>
                        </div>
                        <label for="foto">Foto Profil</label>
                        <input type="file" id="image" class="form-control @error('foto') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select mr-sm-2  @error('level') is-invalid @enderror" id="level"
                            name="level">
