...
{
    function create () {
        return view('AdminView.DataSuplier.create')->with('title', 'Create Supplier');
    }
    ...
    function edit ($id) {
        ...
        return view('AdminView.DataSuplier.updatesuplier')->with('title', 'Edit Supplier')->with('suppliers', $suppliers);
    }
